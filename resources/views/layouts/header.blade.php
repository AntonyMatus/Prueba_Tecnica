        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ Asset(env('admin').'/home') }}"><i class="bx bx-user"></i><span>Inicio</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ Asset(env('admin').'/setting') }}"><i class="bx bx-cog"></i><span>Configuraciones</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ Asset(env('admin').'/category') }}"><i class='bx bx-home-circle'></i><span>Categorias</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ Asset(env('admin').'/adminUser') }}"><i class='bx bx-dollar-circle'></i><span>Sub-Cuentas</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ Asset(env('admin').'/delivery') }}"><i class='bx bx-download'></i><span>Conductores</span></a>
                    </li>
                    <li>
